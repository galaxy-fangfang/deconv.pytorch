...
from proposal_layer_deconv import _ProposalLayer_DECONV
from anchor_target_layer_deconv import _AnchorTargetLayer_DECONV
...
class _RPN_Deconv(nn.Module):
    """ region proposal network """
    def __init__(self, din):
        super(_RPN_Deconv, self).__init__()
        ...
        self.RPN_proposal = _ProposalLayer_DECONV(self.feat_stride, self.anchor_scales, self.anchor_ratios)

        # define anchor target layer
        self.RPN_anchor_target = _AnchorTargetLayer_DECONV(self.feat_stride, self.anchor_scales, self.anchor_ratios)
